...
namespace XBNLibrary.cryptography
{
  ...
  public static class XBNCrypt
  {
    ...
    private static byte[] XBN_Table_A =
    {
    ...
    private static byte[] XBN_Table_B =
    {
    ...
    private static byte[] ASCII_Table =
    {
    ...
    public static string Decrypt(byte[] array, int offset, int length)
    {
      ...
      {
        int position = 0;
        TableType table = getTable(array[i]);
    ...
    public static byte[] Encrypt(string str)
    {
      ...
      for(int i = 0; i < str.Length; i++)
      {
        ...
        TableType table = getTableTypeByAsciiPosition(ascii_position);
        switch(table)
        {
          case TableType.TableA:
